    ...
    <style>
        ...
        *::after {
        ...
        .search-bar:focus-within {
            ...
            box-shadow: 0 0 0 4px rgba(108, 62, 244, 0.12);
        }
        .search-bar input {
            flex: 1;
            border: none;
        ...
        .hero-cta:hover {
            ...
            box-shadow: 0 8px 25px rgba(108, 62, 244, 0.35);
        }
        .hero-icon {
            font-size: 4rem;
            color: var(--primary);
        ...
        .filter-bar .sort-wrap select:focus {
            border-color: var(--primary);
        }
        ...
        .product-info .add-btn.in-cart {
            background: #22c55e;
        }
        .product-info .add-btn.in-cart:hover {
            background: #16a34a;
        }
        ...
        .checkout-modal .modal-box h2 i {
            color: #22c55e;
        }
        .checkout-modal .modal-box p {
            color: var(--text-muted);
            font-size: 0.95rem;
            margin-bottom: 20px;
        }
        .checkout-modal .modal-box .order-summary {
            background: var(--bg);
            padding: 16px 18px;
            border-radius: var(--radius-sm);
            margin-bottom: 20px;
        ...
        .checkout-modal .modal-box .order-summary .row {
            display: flex;
            justify-content: space-between;
            padding: 4px 0;
        }
        .checkout-modal .modal-box .order-summary .row.total {
            font-weight: 700;
            border-top: 1px solid var(--border);
            padding-top: 10px;
            margin-top: 6px;
        ...
        .checkout-modal .modal-box .order-summary .items-list {
            margin-top: 12px;
            font-size: 0.85rem;
            color: var(--text-muted);
            border-top: 1px solid var(--border);
        ...
        .checkout-modal .confirm-btn:hover {
            background: #16a34a;
            transform: scale(1.01);
        }
...
<body>
    ...
    <!-- ============================================================ -->
    <!-- JSP: DEFINE PRODUCT DATA (dynamic, no backend)                -->
    <!-- ============================================================ -->
    <c:set var="products" scope="page">
        <c:forEach items="[
            {id:1, name:'Smartphone Pro Max', category:'electronics', price:999.99, oldPrice:1199.99, rating:4.9, reviews:512, emoji:'📱', badge:'Bestseller'},
            {id:2, name:'Ultrabook Laptop 16\"', category:'electronics', price:1499.99, oldPrice:1799.99, rating:4.8, reviews:284, emoji:'💻', badge:'New'},
            {id:3, name:'Wireless Noise-Canceling Headphones', category:'electronics', price:149.99, oldPrice:199.99, rating:4.7, reviews:342, emoji:'🎧', badge:'Sale'},
            {id:4, name:'Premium Cotton T-Shirt (Pack of 3)', category:'clothing', price:39.99, oldPrice:null, rating:4.5, reviews:187, emoji:'👕', badge:null},
            {id:5, name:'Smart LED Desk Lamp with Qi Charger', category:'electronics', price:79.99, oldPrice:99.99, rating:4.6, reviews:93, emoji:'💡', badge:null},
            {id:6, name:'Minimalist Ceramic Coffee Mug Set', category:'home', price:24.99, oldPrice:null, rating:4.3, reviews:215, emoji:'☕', badge:null},
            {id:7, name:'Hydrating Face Serum with Vitamin C', category:'beauty', price:54.99, oldPrice:69.99, rating:4.9, reviews:412, emoji:'🧴', badge:'Bestseller'},
            {id:8, name:'Slim Fit Jeans (Stretch Denim)', category:'clothing', price:59.99, oldPrice:null, rating:4.4, reviews:108, emoji:'👖', badge:null},
            {id:9, name:'Portable Bluetooth Speaker, 20W', category:'electronics', price:89.99, oldPrice:119.99, rating:4.6, reviews:276, emoji:'🔊', badge:'Sale'},
            {id:10, name:'Bamboo Cutting Board Set (3-Piece)', category:'home', price:34.99, oldPrice:null, rating:4.2, reviews:89, emoji:'🪵', badge:null},
            {id:11, name:'Organic Rose Water Toner 200ml', category:'beauty', price:19.99, oldPrice:26.99, rating:4.7, reviews:334, emoji:'🌹', badge:null},
            {id:12, name:'Classic Leather Backpack 15\"', category:'clothing', price:74.99, oldPrice:89.99, rating:4.8, reviews:156, emoji:'🎒', badge:'New'},
            {id:13, name:'Scented Soy Candle Jar (Lavender)', category:'home', price:16.99, oldPrice:null, rating:4.1, reviews:67, emoji:'🕯️', badge:null},
            {id:14, name:'Wireless Charging Pad (Fast Charge)', category:'electronics', price:29.99, oldPrice:44.99, rating:4.4, reviews:203, emoji:'🔋', badge:'Sale'},
            {id:15, name:'4K Action Camera Waterproof', category:'electronics', price:199.99, oldPrice:249.99, rating:4.7, reviews:128, emoji:'📷', badge:null}
        ]" var="p">
            <c:set target="${products}" property="${p.id}" value="${p}" />
        </c:forEach>
    </c:set>
    ...
    <%
        ...
        p1.put("id", 1);
        p1.put("name", "Smartphone Pro Max");
        p1.put("category", "electronics");
        p1.put("price", 999.99);
        p1.put("oldPrice", 1199.99);
        p1.put("rating", 4.9);
        p1.put("reviews", 512);
        p1.put("emoji", "📱");
        p1.put("badge", "Bestseller");
        productList.add(p1);

        java.util.Map<String, Object> p2 = new java.util.HashMap<>();
        p2.put("id", 2);
        p2.put("name", "Ultrabook Laptop 16\"");
        p2.put("category", "electronics");
        p2.put("price", 1499.99);
        p2.put("oldPrice", 1799.99);
        p2.put("rating", 4.8);
        p2.put("reviews", 284);
        p2.put("emoji", "💻");
        p2.put("badge", "New");
        ...
        p3.put("id", 3);
        p3.put("name", "Wireless Noise-Canceling Headphones");
        p3.put("category", "electronics");
        p3.put("price", 149.99);
        p3.put("oldPrice", 199.99);
        p3.put("rating", 4.7);
        p3.put("reviews", 342);
        p3.put("emoji", "🎧");
        p3.put("badge", "Sale");
        ...
        p4.put("id", 4);
        p4.put("name", "Premium Cotton T-Shirt (Pack of 3)");
        p4.put("category", "clothing");
        p4.put("price", 39.99);
        p4.put("oldPrice", null);
        p4.put("rating", 4.5);
        p4.put("reviews", 187);
        p4.put("emoji", "👕");
        p4.put("badge", null);
        ...
        p5.put("id", 5);
        p5.put("name", "Smart LED Desk Lamp with Qi Charger");
        p5.put("category", "electronics");
        p5.put("price", 79.99);
        p5.put("oldPrice", 99.99);
        p5.put("rating", 4.6);
        p5.put("reviews", 93);
        p5.put("emoji", "💡");
        p5.put("badge", null);
        ...
        p6.put("id", 6);
        p6.put("name", "Minimalist Ceramic Coffee Mug Set");
        p6.put("category", "home");
        p6.put("price", 24.99);
        p6.put("oldPrice", null);
        p6.put("rating", 4.3);
        p6.put("reviews", 215);
        p6.put("emoji", "☕");
        p6.put("badge", null);
        ...
        p7.put("id", 7);
        p7.put("name", "Hydrating Face Serum with Vitamin C");
        p7.put("category", "beauty");
        p7.put("price", 54.99);
        p7.put("oldPrice", 69.99);
        p7.put("rating", 4.9);
        p7.put("reviews", 412);
        p7.put("emoji", "🧴");
        p7.put("badge", "Bestseller");
        productList.add(p7);

        java.util.Map<String, Object> p8 = new java.util.HashMap<>();
        p8.put("id", 8);
        p8.put("name", "Slim Fit Jeans (Stretch Denim)");
        p8.put("category", "clothing");
        p8.put("price", 59.99);
        p8.put("oldPrice", null);
        p8.put("rating", 4.4);
        p8.put("reviews", 108);
        p8.put("emoji", "👖");
        p8.put("badge", null);
        ...
        p9.put("id", 9);
        p9.put("name", "Portable Bluetooth Speaker, 20W");
        p9.put("category", "electronics");
        p9.put("price", 89.99);
        p9.put("oldPrice", 119.99);
        p9.put("rating", 4.6);
        p9.put("reviews", 276);
        p9.put("emoji", "🔊");
        p9.put("badge", "Sale");
        ...
        p10.put("id", 10);
        p10.put("name", "Bamboo Cutting Board Set (3-Piece)");
        p10.put("category", "home");
        p10.put("price", 34.99);
        p10.put("oldPrice", null);
        p10.put("rating", 4.2);
        p10.put("reviews", 89);
        p10.put("emoji", "🪵");
        p10.put("badge", null);
        ...
        p11.put("id", 11);
        p11.put("name", "Organic Rose Water Toner 200ml");
        p11.put("category", "beauty");
        p11.put("price", 19.99);
        p11.put("oldPrice", 26.99);
        p11.put("rating", 4.7);
        p11.put("reviews", 334);
        p11.put("emoji", "🌹");
        p11.put("badge", null);
        ...
        p12.put("id", 12);
        p12.put("name", "Classic Leather Backpack 15\"");
        p12.put("category", "clothing");
        p12.put("price", 74.99);
        p12.put("oldPrice", 89.99);
        p12.put("rating", 4.8);
        p12.put("reviews", 156);
        p12.put("emoji", "🎒");
        p12.put("badge", "New");
        ...
        p13.put("id", 13);
        p13.put("name", "Scented Soy Candle Jar (Lavender)");
        p13.put("category", "home");
        p13.put("price", 16.99);
        p13.put("oldPrice", null);
        p13.put("rating", 4.1);
        p13.put("reviews", 67);
        p13.put("emoji", "🕯️");
        p13.put("badge", null);
        ...
        p14.put("id", 14);
        p14.put("name", "Wireless Charging Pad (Fast Charge)");
        p14.put("category", "electronics");
        p14.put("price", 29.99);
        p14.put("oldPrice", 44.99);
        p14.put("rating", 4.4);
        p14.put("reviews", 203);
        p14.put("emoji", "🔋");
        p14.put("badge", "Sale");
        ...
        p15.put("id", 15);
        p15.put("name", "4K Action Camera Waterproof");
        p15.put("category", "electronics");
        p15.put("price", 199.99);
        p15.put("oldPrice", 249.99);
        p15.put("rating", 4.7);
        p15.put("reviews", 128);
        p15.put("emoji", "📷");
        p15.put("badge", null);
    ...
    <main>
        ...
        <div class="stats-bar">
            <div class="stat-item">
                ...
                <span><strong id="totalProducts">${productList.size()}</strong> <span class="stat-value">Products</span></span>
            </div>
            <div class="stat-item">
        ...
        <div class="product-grid" id="productGrid">
            <%-- Rendered by JavaScript using data from JSP --%>
        </div>
    </main>
    ...
    <script>
        // ============================================================
        //  DATA — pulled from JSP server-side data
        // ============================================================
        const products = [
            <c:forEach var="p" items="${productList}" varStatus="status">
            {
                ...
                reviews: ${p.reviews},
                emoji: '${p.emoji}',
                badge: ${p.badge != null ? "'" + p.badge + "'" : 'null'}
        ...
        const categoryGradients = {
            electronics: 'linear-gradient(135deg, #3b82f6, #8b5cf6)',
            clothing: 'linear-gradient(135deg, #ec4899, #f43f5e)',
            home: 'linear-gradient(135deg, #f59e0b, #f97316)',
            beauty: 'linear-gradient(135deg, #ec4899, #a855f7)'
        };

        function getGradient(category) {
            return categoryGradients[category] || 'linear-gradient(135deg, #6c3ef4, #a78bfa)';
        }
        ...
        function renderCart() {
            ...
            cart.forEach(item => {
                ...
                const gradient = product ? getGradient(product.category) : 'linear-gradient(135deg, #6c3ef4, #a78bfa)';
                html += `
        ...
        console.log('🚀 ShopVerse JSP loaded with ' + products.length + ' products from server data!');
